                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                <?php
								if($_SESSION['level']== 'kode_user'){
									$sesi=$_SESSION['PIMPINAN'];
									}else if($_SESSION['level']=='kode_user'){
									$sesi=$_SESSION['PETUGAS'];
									}else if($_SESSION['level']=='kode_user'){
									$sesi=$_SESSION['PEGAWAI'];
									}
									
									$sql_profil=mysqli_query("select * from user_pegawai where nip='$nip'") or die(mysql_error());
...
if (isset($_POST ['save'])) {
	...
	{
        $query="UPDATE user_pegawai SET nama='$nama',tgl_lhr='$tgl_lhr',jns_kel='$jns_kel',agama='$agama',alamat='$alamat',telp='$telp',email='$email',password='$password' WHERE kode_user='$sesi'";
        $sql=mysqli_query($connect,$query);
