                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="POST" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="tgl_pensiun" name="tgl_pensiun" placeholder="Tanggal Pensiun" value="<?=$hasil['tgl_pensiun']?>" type="text"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Talamat pensiun</label>
                                            <textarea class="form-control" name="alamat_pensiun" value="<?=$hasil['alamat_pensiun']?>"></textarea>
                                        </div>
...
if (isset($_POST ['save'])) {
	...
	{
        $query="UPDATE tb_pesiun SET nip_peg='$nip_peg_lama',nama_peg='$nama_peg',jenis_pensiun='$jenis_pensiun',tgl_pensiun='$tgl_pensiun',alamat_pensiun='$alamat_pensiun' WHERE kode_pensiun='$nip_peg_edit'";
        $sql=mysqli_query($connect,$query);
