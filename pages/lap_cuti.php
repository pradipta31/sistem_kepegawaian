...
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Laporan Cuti</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
...
<img src="../img/xxx.png" style="width: 100px; height: 100px;"> 
  ...
  <hr></hr>
			<br>
              ...
              <h3 align="center" style="font-size:18px; margin-bottom: : 30px;">Laporan Data Pegawai Cuti</h3>
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                </div>
                                  <br>
                                    <table class="table table-bordered" border='1' cellpadding="0" cellspacing="0">
                                        ...
                                        <th style="width:300px; border:1px solid #000;">Jenis Cuti</th>
                                        <th style="width:300px; border:1px solid #000;">Tanggal Cuti</th>
                                        <th style="width:300px; border:1px solid #000;">Lama Cuti</th>
                                    </tr>
<?php  
                                		$i=1;
                                	...
                                	?>
	                                    <tr>
                                            ...
                                            <td align="center" style="border:1px #000 solid"><?=$hasil['telepon']?></td>
                                            <td align="center" style="border:1px #000 solid"><?=$hasil['jns_cuti']?></td>
                                            <td align="center" style="border:1px #000 solid"><?=$hasil['tgl_cuti']?></td>
                                            <td align="center" style="border:1px #000 solid"><?=$hasil['lama_cuti']?></td>
                                            </tr>
                                    <?php  
                                			}
                                	?>  
